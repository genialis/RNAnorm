...
#     FPKM expressions of a minimal example have been
...
#     manually_computed_FPKM = [
#        [50000, 16000], [50000, 480000], [170000, 4800]
#        ]
...
#     assert np.all(FPKM.astype(int) == manually_computed_FPKM)
